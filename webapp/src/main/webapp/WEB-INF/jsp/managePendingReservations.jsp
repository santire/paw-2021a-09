            ...
            <section>
                <div class="container mt-4">
                    ...
                    <ul class="nav nav-pills nav-fill navtop mt-5">
                        <li class="nav-item">
                            <a class="nav-link"  href="${pageContext.request.contextPath}/restaurant/${restaurantId}/manage/confirmed"><spring:message code="restaurant.manage.confirmedTab"/></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="#"><spring:message code="restaurant.manage.pendingTab"/></a>
                        </li>
                    </ul>
