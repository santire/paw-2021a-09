...
public class ReservationServiceImpl implements ReservationService{
    ...
    public Reservation addReservation(long userId, long restaurantId, Date date, long quantity) {
        ...
        Restaurant restaurant = restaurantService.findById(reservation.getId()).orElseThrow(() -> new IllegalStateException("Reservation: Restaurant doesnt exist"));
        ...
        +"Su reserva para " +restaurant.getName()+" se ha realizado con exito"
        ...
        email.setMailSubject(messageSource.getMessage("Username",null,locale));
